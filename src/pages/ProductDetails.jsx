...
const ProductDetails = () => {
  const { product, relatedProduct, moreProducts } = useSelector(
    (state) => state.home
  );
                    ...
                    {product.images.map((img, i) => {
                      return (
                        <div key={i} onClick={() => setImage(img)}>
                          <img
                            className="rounded-md cursor-pointer h-[130px] w-[130px]"
                            src={img}
                          />
                        </div>
                      );
              ...
              <div className="flex gap-3 pb-10 border-b">
                ...
                <div>
                  <div
                    ...
                    className="h-[50px] w-[50px] flex justify-center items-center bg-violet-500 hover:shadow-md hover:shadow-violet-500/50 rounded-full cursor-pointer text-white text-xl "
                  >
                    <AiFillHeart />
                  </div>
                </div>
