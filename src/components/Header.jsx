          ...
          <div className="flex w-full items-center justify-between h-[50px] text-slate-400">
            ...
            <div>
              <div className="flex items-center justify-center gap-10">
                ...
                <div>
                  <div className="flex cursor-pointer group text-slate-800 text-sm justify-center items-center gap-1 relative after:h-[18px] after:w-[1px] after:bg-[#afafaf] after:absolute before:absolute after:-right-[16px] before:h-[18px] before:w-[1px] before:bg-[#afafaf] before:-left-[16px]">
                    {/* <img src="" alt="" /> */}
                    <span className="fi fi-um text-2xl"></span>
                    <span className="">
                      <MdOutlineKeyboardArrowDown />
                    </span>
                    <ul className="absolute invisible p-2 transition-all rounded-sm duration-200 text-white w-[100px] flex flex-col gap-3 group-hover:visible group-hover:bg-black top-10 ">
                      <ul>
                        <li>Bangla</li>
                        <li>English</li>
                      </ul>
      ...
      <div className="hidden md-lg:block">
        ...
        >
          ...
          <div className="flex justify-start gap-10 items-center mt-6">
            <div className="flex cursor-pointer group text-slate-800 text-sm justify-center items-center gap-1 relative after:h-[18px] after:w-[1px] after:bg-[#afafaf] after:absolute  after:-right-[16px]">
              {/* <img src="" alt="" /> */}
              <span className="fi fi-um text-2xl"></span>
              <span className="">
                <MdOutlineKeyboardArrowDown />
          ...
          <ul className="flex justify-start items-start gap-2 flex-col mt-4 font-bold uppercase">
            ...
            <li>
              <Link
                className={`py-2 block ${
                  pathname === "/blog" ? "text-green-700" : "text-slate-700"
                }`}
              >
                Blog
              </Link>
          ...
          <div className="flex justify-start mt-2 items-center gap-4 text-2xl">
            <a href="#" className="text-blue-800">
              {" "}
              <AiOutlineFacebook />{" "}
            </a>
